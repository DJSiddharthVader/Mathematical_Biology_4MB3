...
\includegraphics[width=\maxwidth]{figure/_singlePatchHL-1} \caption{\label{fig:basesp} Plot of the SIRW model for a single patch with severity compartments. Parameters are $\mu=7e-05,\beta_l=0.016,\beta_h=0.016,\gamma=0.14286,\sigma=0.04,\beta_w=0.5,\xi_l=0.07,\xi_h=0.14,\alpha_l=0.01,\alpha_h=0.05$ The initial conditions for the model were $S_0=0.99,L_0=0.01,H_0=0,R_0=0,$.}\label{fig:<singlePatchHL}
\end{figure}
