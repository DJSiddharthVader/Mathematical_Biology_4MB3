...
@
<<child='./sections/results.Rnw'>>=
@
<<child='./sections/discussion.Rnw'>>=
@
%Sections sexpr
%\Sexpr{knit_child('./sections/background.Rnw')}
%\Sexpr{knit_child('./sections/model_description.Rnw')}
%\Sexpr{knit_child('./sections/multipatch.Rnw')}
%\Sexpr{knit_child('./sections/results.Rnw')}
%\Sexpr{knit_child('./sections/discussion.Rnw')}
%End Note
\bigskip\vfill
