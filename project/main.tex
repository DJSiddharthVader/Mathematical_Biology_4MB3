...
\includegraphics[width=\maxwidth]{figure/_singlePatch-1} \caption{\label{fig:singlepatch} Plot of the SIRW model for a single patch. Parameters are $\mu=0.15\ \beta_i=0.06\ \gamma=0.14\ \sigma=0.07\ \beta_w=0.15$.Further the initial conditions for the model were $S_0=0.92\ I_0=0.08\ R_0=0$}\label{fig:<singlePatch}
\end{figure}
